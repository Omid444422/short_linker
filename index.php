...
<body>
    ...
    <div class="container mt-5">
        <div class='d-flex justify-content-start'>
           ...
           <a class="nav-item btn btn-danger ms-2" href="index.php">link creator</a>
           <?php endif; ?>
            <a class="nav-item btn btn-info ms-2" href="index.php?event=url_list">show url list</a>
        </div>
    </div>
    ...
    if (isset($_POST['btn_submit'])) {
        if (
            isset($_POST['txt_short_link']) && $_POST['txt_short_link'] !== ''
    ...
    <?php if (!isset($_GET['event'])) { ?>
        <div class="container-fluid row justify-content-center mt-5">
            <div class="col-8 bg-dark rounded-3 mt-3 p-2 text-light">
                <form action="./index.php" method="POST">
                    ...
                    <button class="btn btn-warning" >ایجاد لینک رندوم</button>
                </form>
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $links['status'] == 1? 'فعال': 'غیر فعال' ?>
                                        </td>
